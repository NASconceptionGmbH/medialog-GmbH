table 60711 "CDS cos_sparten"
{
  ExternalName = 'cos_sparten';
  TableType = CDS;
  Description = '';

  fields
  {
    field(1;cos_spartenId;GUID)
    {
      ExternalName = 'cos_spartenid';
    ...
    field(26;statuscode;Option)
    {
      ...
      ExternalType = 'Status';
      Description = 'Grund für den Status von Sparte';
      Caption = 'Statusgrund';
      InitValue = " ";
      OptionMembers = " ", Aktiv, Inaktiv;
