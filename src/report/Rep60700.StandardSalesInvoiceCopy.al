report 60700 "Standard Sales - Invoice Copy"
{
    ...
    dataset
    {
        ...
        "Sales Invoice Header")
        {
            ...
            column(CompanyBankBranchNo_Lbl;
            CompanyInfo.FieldCaption("Bank Branch No."))
            {
            }
            column(CompanyBankAccountNo;
            CompanyInfo."Bank Account No.")
            {
            }
            column(CompanyBankAccountNo_Lbl;
            ...
            column(CompanyRegistrationNumber_Lbl;
            ...
            column(CompanyVATRegNo_Lbl;
            CompanyInfo.GetVATRegistrationNumberLbl)
            {
            }
            column(CompanyVATRegistrationNo;
            CompanyInfo.GetVATRegistrationNumber)
            {
            }
            column(CompanyVATRegistrationNo_Lbl;
            CompanyInfo.GetVATRegistrationNumberLbl)
            {
            }
            ...
            column(ShipmentMethodDescription_Lbl;
            ShptMethodDescLbl)
            {
            }
            column(ShipmentDate;
            ...
            column(ShowShippingAddress;
            ShowShippingAddr)
            {
            }
            column(ShipToAddress_Lbl;
            ShiptoAddrLbl)
            {
            }
            ...
            column(PaymentTermsDescription_Lbl;
            PaymentTermsDescLbl)
            {
            }
            ...
            column(PaymentMethodDescription_Lbl;
            PaymentMethodDescLbl)
            {
            }
            column(BilltoCustumerNo;
            "Bill-to Customer No.")
            {
            }
            column(BilltoCustomerNo_Lbl;
            ...
            FieldCaption("Prices Including VAT"))
            {
            }
            column(PricesIncludingVATYesNo;
            Format("Prices Including VAT"))
            {
            }
            column(SalesPerson_Lbl;
            SalespersonLbl)
            {
            }
            column(SalesPersonBlank_Lbl;
            SalesPersonText)
            {
            }
            ...
            column(EMail_Header_Lbl;
            EMailLbl)
            {
            }
            column(HomePage_Header_Lbl;
            HomePageLbl)
            {
            }
            column(InvoiceDiscountBaseAmount_Lbl;
            InvDiscBaseAmtLbl)
            {
            }
            column(InvoiceDiscountAmount_Lbl;
            InvDiscountAmtLbl)
            {
            }
            column(LineAmountAfterInvoiceDiscount_Lbl;
            LineAmtAfterInvDiscLbl)
            {
            }
            column(LocalCurrency_Lbl;
            LocalCurrencyLbl)
            {
            }
            column(ExchangeRateAsText;
            ExchangeRateText)
            {
            }
            column(Page_Lbl;
            ...
            column(SalesInvoiceLineDiscount_Lbl;
            SalesInvLineDiscLbl)
            {
            }
            column(Questions_Lbl;
            QuestionsLbl)
            {
            }
            column(Contact_Lbl;
            CompanyInfo.GetContactUsText)
            {
            }
            column(DocumentTitle_Lbl;
            DocumentCaption)
            {
            }
            column(YourDocumentTitle_Lbl;
            YourSalesInvoiceLbl)
            {
            }
            column(Thanks_Lbl;
            ...
            column(VATAmountSpecification_Lbl;
            VATAmtSpecificationLbl)
            {
            }
            column(VATClauses_Lbl;
            VATClausesLbl)
            {
            }
            column(VATIdentifier_Lbl;
            VATIdentifierLbl)
            {
            }
            column(VATPercentage_Lbl;
            VATPercentageLbl)
            {
            }
            ...
            FieldCaption("Package Tracking No."))
            {
            }
            ...
            column(ExternalDocNo;
            "External Document No.")
            {
            }
            column(ExternalDocNo_Lbl;
            ...
            "Sales Invoice Line")
            {
                ...
                column(AmountExcludingVAT_Line_Lbl;
                FieldCaption(Amount))
                {
                }
                ...
                column(AmountIncludingVAT_Line_Lbl;
                FieldCaption("Amount Including VAT"))
                {
                    AutoFormatExpression = GetCurrencyCode;
                    AutoFormatType = 1;
                }
                ...
                column(LineAmount_Line_Lbl;
                FieldCaption("Line Amount"))
                {
                }
                column(ItemNo_Line;
                "No.")
                ...
                column(UnitPriceInclVAT;
                UnitCostInclVat)
                {
                    DecimalPlaces = 0 : 2;
                }
                column(UnitOfMeasure_Lbl;
                ...
                "Sales Shipment Buffer")
                {
                    ...
                    column(PostingDate_ShipmentLine;
                    "Posting Date")
                    {
                    }
                    column(PostingDate_ShipmentLine_Lbl;
                    FieldCaption("Posting Date"))
                    {
                    }
                    column(Quantity_ShipmentLine;
                    Quantity)
                    {
                        DecimalPlaces = 0 : 5;
                    }
                    column(Quantity_ShipmentLine_Lbl;
                    FieldCaption(Quantity))
                    {
                    }
            ...
            "VAT Amount Line")
            {
                ...
                column(InvoiceDiscountAmount_VATAmountLine_Lbl;
                FieldCaption("Invoice Discount Amount"))
                {
                }
                ...
                column(InvoiceDiscountBaseAmount_VATAmountLine_Lbl;
                FieldCaption("Inv. Disc. Base Amount"))
                {
                }
                ...
                column(LineAmount_VatAmountLine_Lbl;
                FieldCaption("Line Amount"))
                {
                }
                ...
                column(VATAmount_VatAmountLine_Lbl;
                FieldCaption("VAT Amount"))
                {
                }
                ...
                column(VATAmountLCY_VATAmountLine_Lbl;
                VATAmountLCYLbl)
                {
                }
                ...
                column(VATBase_VatAmountLine_Lbl;
                FieldCaption("VAT Base"))
                {
                }
                ...
                column(VATBaseLCY_VATAmountLine_Lbl;
                VATBaseLCYLbl)
                {
                }
                ...
                column(VATIdentifier_VatAmountLine_Lbl;
                FieldCaption("VAT Identifier"))
                {
                }
                ...
                column(VATPct_VatAmountLine_Lbl;
                FieldCaption("VAT %"))
                {
                }
            ...
            "Integer")
            {
                ...
                column(TotalVATBaseLCY;
                TotalVATBaseLCY)
                {
                }
                column(TotalAmountIncludingVAT;
                TotalAmountInclVAT)
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                ...
                column(TotalVATAmountText;
                VATAmountLine.VATAmountText)
                {
                }
                column(TotalExcludingVATText;
                TotalExclVATText)
                {
                }
                column(TotalIncludingVATText;
                TotalInclVATText)
                {
                }
                ...
                column(TotalSubTotalMinusInvoiceDiscount;
                TotalSubTotal + TotalInvDiscAmount)
                {
                }
                column(TotalText;
                TotalText)
                ...
                column(TotalAmountExclInclVAT;
                TotalAmountExclInclVATValue)
                {
                }
                column(TotalAmountExclInclVATText;
                TotalAmountExclInclVATTextValue)
                {
                }
                column(TotalLineDiscountAmount;
            ...
            begin
                ...
                if Cust.Get("Sell-to Customer No.") then
                    if Cust."VAT Registration No." <> '' then
                        VATID := Cust."VAT Registration No.";
            end;
    ...
    local procedure FillNameValueTable(var NameValueBuffer: Record "Name/Value Buffer";
    Name: Text;
    Value: Text)
    var
        KeyIndex: Integer;
    ...
    local procedure GetJobTaskDescription(JobNo: Code[20];
    JobTaskNo: Code[20]): Text[100]
    var
    ...
    local procedure OnAfterLineOnPreDataItem(var SalesInvoiceHeader: Record "Sales Invoice Header";
    var SalesInvoiceLine: Record "Sales Invoice Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeLineOnAfterGetRecord(var SalesInvoiceHeader: Record "Sales Invoice Header";
    var SalesInvoiceLine: Record "Sales Invoice Line")
    begin
    end;
    ...
    var
        SEPALbl: Label 'Wie vereinbart buchen wir den Betrag abzüglich %1 Skonto (verbleiben %2 EUR) von Ihrem Konto ab.';
