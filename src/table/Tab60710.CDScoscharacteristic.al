table 60710 "CDS cos_characteristic"
{
  ExternalName = 'cos_characteristic';
  TableType = CDS;
  Description = '';

  fields
  {
    field(1;cos_characteristicId;GUID)
    {
      ExternalName = 'cos_characteristicid';
    ...
    field(24;statecode;Option)
    {
      ...
      Description = 'Status von Merkmal';
      Caption = 'Status';
      InitValue = " ";
    ...
    field(26;statuscode;Option)
    {
      ...
      ExternalType = 'Status';
      Description = 'Grund für den Status von Merkmal';
      Caption = 'Statusgrund';
      InitValue = " ";
      OptionMembers = " ", Aktiv, Inaktiv;
