table 60707 "CDS cos_typeofcustomer"
{
  ...
  fields
  {
    field(1;cos_typeofcustomerId;GUID)
    {
    ...
    field(24;statecode;Option)
    {
      ...
      Description = 'Status von Kundenart';
      Caption = 'Status';
      InitValue = " ";
    ...
    field(26;statuscode;Option)
    {
      ...
      ExternalType = 'Status';
      Description = 'Grund für den Status von Kundenart';
      Caption = 'Statusgrund';
      InitValue = " ";
      OptionMembers = " ", Aktiv, Inaktiv;
